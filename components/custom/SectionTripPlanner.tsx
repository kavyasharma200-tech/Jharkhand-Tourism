  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-6">
        <h2 className="text-4xl md:text-5xl font-['Anton'] uppercase tracking-tighter mb-12 text-center border-b-[8px] border-black pb-4 inline-block w-full">
          🗺️ Plan Your Jharkhand Journey
        </h2>

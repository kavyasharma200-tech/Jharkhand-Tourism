...
export default function SectionStats() {
  ...
  return (
    <section ref={sectionRef} className="w-full h-screen bg-white flex flex-col items-center justify-center py-24 overflow-hidden border-t border-black/5 px-8 md:px-24">
      ...
      <div ref={statsRef} className="flex flex-col md:flex-row items-center justify-center gap-16 md:gap-8 w-full overflow-x-auto whitespace-nowrap scrollbar-hide">
        {stats.map((stat, i) => (

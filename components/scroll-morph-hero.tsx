...
const IMAGES = [
  ...
  "/assets/Netarhat/betla-national-park-located-jharkhand-pristine-wildlife-sanctuary-dense-forests-grasslands-diverse-array-349033212.webp",
            ...
            <div className="flex h-full w-full flex-col items-center justify-center perspective-1000">
                ...
                <div className="absolute z-0 flex flex-col items-center justify-center text-center pointer-events-none top-1/2 -translate-y-1/2">
                    <motion.h1
                        ...
                        className="font-['Anton'] text-[5vw] md:text-[8vw] text-black tracking-tight leading-none uppercase"
                    >
                        JHARKHAND IS A TOURISM PARADISE
                    </motion.h1>
                    <motion.p
                        initial={{ opacity: 0 }}
                        animate={introPhase === "circle" && morphValue < 0.5 ? { opacity: 0.5 - morphValue } : { opacity: 0 }}
                        transition={{ duration: 1, delay: 0.2 }}
                        className="mt-4 font-['Space_Mono'] text-[11px] tracking-[0.25em] text-black/50 uppercase"
                    >
                        28 DISTRICTS. INFINITE WILDERNESS.
                    </motion.p>
                </div>
                ...
                >
                    <h2 className="font-['Anton'] text-[4vw] md:text-[6vw] text-black tracking-tight mb-4 uppercase leading-none">
                        Explore Our Vision
                    </h2>
                    <p className="font-['Space_Mono'] text-xs text-black/50 max-w-lg leading-relaxed uppercase tracking-[0.2em]">
                        Discover a world where nature meets culture. <br className="hidden md:block" />
                        Scroll through our curated collection of wilderness and heritage.
                    </p>
                </motion.div>
